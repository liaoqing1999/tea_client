...
import EditStaff from '../../sys/staff/edit';
import { formateDate } from '../../../../utils/dateUtils';
import { GetRoleSelect } from '../../sys/staff/orgRoleSelect';
import sessionUtils from '../../../../utils/sessionUtils';
const { Option } = Select;
export default class OrgStaff extends Component {
    state = {
        staff: {},
        org: "",
        user: {},
    ...
    render() {
        ...
        const title = (
            <div>
                <Row justify="space-between" gutter={30} style={{ marginBottom: "10px" }}>
                    <Col span={5}><Input allowClear onChange={({ target: { value } }) => cond.name = value} defaultValue={cond.name} placeholder="请输入用户名"></Input></Col>
                    <Col span={5}> <GetRoleSelect style={{ width: "100%" }} onChange={(value) => cond.role = value} value={cond.role}></GetRoleSelect></Col>
                    <Col span={5}>
                        <Select
                            showSearch
                            allowClear
        ...
        return (
            <div className="role">
                ...
                >
                    <EditStaff dict={dict} editType='orgSys' type={type} onFinish={this.onFinish} user={user} hideModal={() => { this.setState({ editVisible: false }) }}></EditStaff>
                </Modal>
